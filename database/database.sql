...
(2, '2026-04-15', '08:00', '17:15', N'Về sớm', 0, 15, 50000, N'Ra sớm do có việc gia đình'),
...
(2, '2026-05-19', '08:00', '17:00', N'Về sớm', 0, 30, 100000, N'Ra sớm đi khám nha khoa'),
...
(2, '2026-06-19', '08:00', '17:25', N'Về sớm', 0, 5, 50000, N'Ra sớm 5 phút'),
...
(2, '2026-07-03', '07:58', '17:30', N'Đúng giờ', 0, 0, 0, N'');
GO
...
(1, '2026-07-03', '07:50', '17:30', N'Đúng giờ', 0, 0, 0, N'');
GO
...
(3, '2026-07-03', '08:10', '17:30', N'Đi trễ', 10, 0, 50000, N'');
GO
...
(4, '2026-07-03', '08:00', '17:30', N'Đúng giờ', 0, 0, 0, N'');
GO
...
(7, '2026-07-03', '07:55', '17:30', N'Đúng giờ', 0, 0, 0, N'');
GO
